"""Regression checks for the ocamltype casebook."""
...
from casebook.harness import assert_expected, ocamltype_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ocamltype_summary(), assert_expected())
