...
ocamltype is a OCaml project for compilers. It focuses on this technical goal: Infer simple Hindley-Milner types for lets and lambdas.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 155, risk penalty 4, latency penalty 4, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
