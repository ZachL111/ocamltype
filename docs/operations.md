...
`ocamltype` is centered on compilers work in OCaml. The technical target is: Infer simple Hindley-Milner types for lets and lambdas.
...
The score is deterministic. The current threshold is 155. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 3.
